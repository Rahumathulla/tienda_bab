 ...
 * @author rahumathulla
 */
public class ViewDummySales extends javax.swing.JFrame implements ActionListener{
    ...
    private void cmdCancelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdCancelActionPerformed
        ...
        dummySales.setBounds(100, 20, 960, 640);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewDummySales.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewDummySales().setVisible(true);
            }
        });
    }
    ...
    public void initializeForm(){
        ...
        renderDataIntoTable(estimateDAO.retrieveSalesByQuery(QueryStrings.viewSalesSql));
    ...
    public void syncDataFromViewToTable(){
        ...
        EstimateDAO estimateDAO = new EstimateDAO();
        sales = estimateDAO.retrieveBySalesId(Long.parseLong(salesId));

        DummySales dummySales = new DummySales();
        //dummySales.fetchSalesDataIntoTable(estimateDAO.retrieveByBillNumber(salesBillNumber));
        dummySales.repaint();
        dummySales.setBounds(100, 20, 980, 680);
        dummySales.setVisible(true); 
        dummySales.fetchSalesDataIntoTable(sales);
        this.dispose();
    }
    ...
    public void actionPerformed(ActionEvent event) {
        try{
            ...
            if (menu == mitDelete) {
                ...
                EstimateDAO estimateDAO = new EstimateDAO();
                //estimateDAO.deleteSalesByBillNumber(billNumber);
                //sales =  estimateDAO.retrieveBySalesId(Long.parseLong(salesId));
                sales =  estimateDAO.retrieveBySalesId(Long.parseLong(salesId));
                ...
                if(sales==null || salesDetailsList.size()<1)
                    ...
                    estimateDAO.updateStockAfterBillDeletion(sales, salesDetailsList, true);
                    estimateDAO = new EstimateDAO();//for re-instating the session
                    estimateDAO.deleteSalesBySalesId(Long.parseLong(salesId));
